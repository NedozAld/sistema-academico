        ...
        <div class="max-w-7xl mx-auto">
            <div class="bg-white overflow-hidden shadow-2xl sm:rounded-3xl p-8 lg:p-12 border border-gray-200">
                <div class="text-center mb-10">
                    ...
                    <p class="text-xl text-gray-600 max-w-2xl mx-auto">Aquí puedes gestionar todas tus actividades académicas de forma sencilla y eficiente.</p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-10">
                    ...
                    <a href="{{ route('estudiante.matricula.form') }}"
                       class="flex flex-col items-center justify-center p-8 bg-gradient-to-br from-green-500 to-green-600 text-white rounded-3xl shadow-xl hover:shadow-2xl transition duration-300 ease-in-out transform hover:-translate-y-2 group relative overflow-hidden">
                        ...
                        <span class="text-3xl font-extrabold text-center relative z-10">Realizar Matrícula</span>
                        <p class="text-base text-center opacity-90 mt-3 relative z-10">Inscríbete en nuevas asignaturas o niveles.</p>
                    </a>

                    {{-- Tarjeta: Ver Materias Matriculadas --}}
                    <a href="{{ route('estudiante.materias') }}"
                       class="flex flex-col items-center justify-center p-8 bg-gradient-to-br from-purple-500 to-purple-600 text-white rounded-3xl shadow-xl hover:shadow-2xl transition duration-300 ease-in-out transform hover:-translate-y-2 group relative overflow-hidden">
                        ...
                        <span class="text-3xl font-extrabold text-center relative z-10">Mis Materias</span>
                        <p class="text-base text-center opacity-90 mt-3 relative z-10">Consulta tus asignaturas matriculadas.</p>
                    </a>

                    {{-- Nueva Tarjeta: Mis Tutorías --}}
                    <a href="{{ route('estudiante.tutorias.index') }}"
                       class="flex flex-col items-center justify-center p-8 bg-gradient-to-br from-yellow-500 to-yellow-600 text-white rounded-3xl shadow-xl hover:shadow-2xl transition duration-300 ease-in-out transform hover:-translate-y-2 group relative overflow-hidden">
                    ...
                    <a href="#"
                       class="flex flex-col items-center justify-center p-8 bg-gradient-to-br from-red-500 to-red-600 text-white rounded-3xl shadow-xl hover:shadow-2xl transition duration-300 ease-in-out transform hover:-translate-y-2 group relative overflow-hidden">
                        ...
                        <span class="text-3xl font-extrabold text-center relative z-10">Configuración</span>
                        <p class="text-base text-center opacity-90 mt-3 relative z-10">Ajusta las preferencias de tu cuenta.</p>
                    </a>
                ...
                <div class="mt-16 pt-10 border-t border-gray-200">
                    ...
                    <div class="bg-gray-50 p-8 rounded-2xl shadow-xl border border-blue-100 relative overflow-hidden">
