                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse ($profesores as $profesor)
                                <tr class="hover:bg-gray-50 transition duration-150 ease-in-out">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">
                                        {{ $profesor->apellidospro }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">
                                        {{ $profesor->telefonopro }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">
                                        {{ $profesor->correopro }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">
                                        {{ $profesor->area->nombreare ?? '—' }}
                                    </td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="7" class="px-6 py-8 text-center text-lg text-gray-600 italic">
                                        ...
                                        <p class="mt-2 text-sm text-gray-500">Haz clic en "Nuevo Profesor" para empezar.</p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
            ...
            <div class="text-center">
                ...
                <div class="mt-2">
                    <p class="text-sm text-gray-500">
                        Esta acción eliminará el profesor de forma permanente.
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            deleteButtons.forEach(button => {
                button.addEventListener('click', function () {
                    currentProfesorId = this.dataset.id;
            ...
            confirmDeleteButton.addEventListener('click', function () {
                if (currentProfesorId) {
                    ...
                    deleteForm.action = `/admin/profesores/${currentProfesorId}`;
                    deleteForm.submit();
                }
            });
