<x-app-layout>
    ...
    <div class="py-12 bg-gradient-to-br from-teal-50 to-cyan-100 min-h-screen p-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-2xl rounded-xl overflow-hidden border border-gray-200">
                <!-- Botón para Nueva Matrícula (opcional, si quieres añadirlo aquí) -->
                <div class="p-6 text-right">
                    <a href="{{ route('admin.matriculas.create') }}"
                       class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-teal-600 hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 transition duration-300 ease-in-out transform hover:-translate-y-0.5">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-100">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider rounded-tr-xl">
                                    Acciones
                                </th>
                            </tr>
                        </thead>
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse ($matriculas as $mat)
                                <tr class="hover:bg-gray-50 transition duration-150 ease-in-out">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">
                                        {{ $mat->periodo->detalleper ?? '—' }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">
                                        {{ \Carbon\Carbon::parse($mat->fechamat)->format('d/m/Y') }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                        <div class="flex items-center justify-center space-x-2">
                                            <!-- Botón para ver detalles (ejemplo) -->
                                            <a href="{{-- route('admin.matriculas.show', $mat->idmat) --}}"
                                               class="inline-flex items-center px-3 py-1.5 border border-transparent text-xs font-medium rounded-md shadow-sm text-white bg-blue-500 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-150 ease-in-out">
                                            ...
                                            <a href="{{-- route('admin.matriculas.edit', $mat->idmat) --}}"
                                            ...
                                            <!-- Botón para eliminar (activará el modal) -->
                                            <button type="button"
                                                    data-id="{{ $mat->idmat }}"
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="px-6 py-8 text-center text-lg text-gray-600 italic">
                                        No hay matrículas registradas aún.
                                        <p class="mt-2 text-sm text-gray-500">Puedes registrar una nueva matrícula haciendo clic en el botón de arriba.</p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
            ...
            <div class="text-center">
                ...
                <div class="mt-2">
                    <p class="text-sm text-gray-500">
                        Esta acción eliminará la matrícula de forma permanente.
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            deleteButtons.forEach(button => {
                button.addEventListener('click', function () {
                    currentMatriculaId = this.dataset.id;
            ...
            confirmDeleteButton.addEventListener('click', function () {
                if (currentMatriculaId) {
                    ...
                    deleteForm.action = `/admin/matriculas/${currentMatriculaId}`;
                    deleteForm.submit();
                }
            });
