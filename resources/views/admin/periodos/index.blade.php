<x-app-layout>
    ...
    <div class="py-12 bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen p-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-2xl rounded-xl p-8 mb-6">
                <!-- Botón para Nuevo Periodo -->
                <div class="mb-6 text-right">
                    <a href="{{ route('admin.periodos.create') }}"
                       class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-300 ease-in-out transform hover:-translate-y-0.5">
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="px-6 py-8 text-center text-lg text-gray-600 italic">
                                        ...
                                        <p class="mt-2 text-sm text-gray-500">Haz clic en "Nuevo Periodo" para empezar.</p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
            ...
            <div class="text-center">
                ...
                <div class="mt-2">
                    <p class="text-sm text-gray-500">
                        Esta acción eliminará el periodo académico de forma permanente.
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            deleteButtons.forEach(button => {
                button.addEventListener('click', function () {
                    currentPeriodoId = this.dataset.id;
            ...
            confirmDeleteButton.addEventListener('click', function () {
                if (currentPeriodoId) {
                    deleteForm.action = `/admin/periodos/${currentPeriodoId}`; // Ajusta la ruta si es necesario
                    deleteForm.submit();
                }
            });
