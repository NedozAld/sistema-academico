            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
                        ...
                        <div class="bg-yellow-50 border-l-4 border-yellow-500 rounded-lg shadow-md p-6 flex flex-col items-center justify-center text-center transform transition duration-300 hover:scale-105 hover:shadow-lg">
                        ...
                        <div class="bg-red-50 border-l-4 border-red-500 rounded-lg shadow-md p-6 flex flex-col items-center justify-center text-center transform transition duration-300 hover:scale-105 hover:shadow-lg">
                            <div class="text-red-600 mb-4">
                                <svg class="w-16 h-16 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 14l9-5-9-5-9 5 9 5zM12 14v9m-9-9h18"></path></svg>
                            </div>
                        ...
                        <div class="bg-indigo-50 border-l-4 border-indigo-500 rounded-lg shadow-md p-6 flex flex-col items-center justify-center text-center transform transition duration-300 hover:scale-105 hover:shadow-lg">
                            <div class="text-indigo-600 mb-4">
                                <svg class="w-16 h-16 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h4l3 8 4-16 3 8h4"></path></svg>
                            </div>
                            <h4 class="text-2xl font-semibold text-gray-800 mb-4">Gestión de Niveles</h4>
                            <p class="text-gray-600 mb-6">Define y organiza los niveles académicos de tu institución.</p>
                            <div class="flex flex-col space-y-4 w-full">
                        ...
                        <div class="bg-purple-50 border-l-4 border-purple-500 rounded-lg shadow-md p-6 flex flex-col items-center justify-center text-center transform transition duration-300 hover:scale-105 hover:shadow-lg">
                            <div class="text-purple-600 mb-4">
                                <svg class="w-16 h-16 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 4h10a2 2 0 012 2v9a2 2 0 01-2 2H7a2 2 0 01-2-2V9a2 2 0 012-2z"></path></svg>
                            </div>
                        ...
                        <div class="bg-orange-50 border-l-4 border-orange-500 rounded-lg shadow-md p-6 flex flex-col items-center justify-center text-center transform transition duration-300 hover:scale-105 hover:shadow-lg">
                        ...
                        <div class="bg-teal-50 border-l-4 border-teal-500 rounded-lg shadow-md p-6 flex flex-col items-center justify-center text-center transform transition duration-300 hover:scale-105 hover:shadow-lg">
                            <div class="text-teal-600 mb-4">
                                <svg class="w-16 h-16 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h2a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v11a2 2 0 002 2h2m10-4h2m1-4h1m-9-2h.01M6 16h.01M6 12h.01M6 8h.01M13 16h.01M13 12h.01M13 8h.01"></path></svg>
                            </div>
                        ...
                        <div class="bg-cyan-50 border-l-4 border-cyan-500 rounded-lg shadow-md p-6 flex flex-col items-center justify-center text-center transform transition duration-300 hover:scale-105 hover:shadow-lg">
                            <div class="text-cyan-600 mb-4">
                                <svg class="w-16 h-16 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14c-1.49 0-2.98.05-4.46.15-2.01.14-3.54 1.67-3.68 3.68C3.79 19.33 5.48 21 7.5 21h9c2.02 0 3.71-1.67 3.64-3.17-.14-2.01-1.67-3.54-3.68-3.68C14.98 14.05 13.49 14 12 14z"></path></svg>
                            </div>
                            <h4 class="text-2xl font-semibold text-gray-800 mb-4">Gestión de Profesores</h4>
                            <p class="text-gray-600 mb-6">Administra la información de los profesores y su asignación.</p>
                            <div class="flex flex-col space-y-4 w-full">
                                <a href=""
