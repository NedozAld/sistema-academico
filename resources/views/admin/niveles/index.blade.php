                ...
                <div class="overflow-x-auto rounded-lg shadow-md border border-gray-200">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            @empty
                                <tr>
                                    <td colspan="3" class="px-6 py-8 text-center text-lg text-gray-600 italic">
                                        No hay niveles académicos registrados aún.
                                        <p class="mt-2 text-sm text-gray-500">Haz clic en "Nuevo Nivel" para empezar.</p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
            ...
            <div class="text-center">
                ...
                <div class="mt-2">
                    <p class="text-sm text-gray-500">
                        Esta acción eliminará el nivel académico de forma permanente.
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            deleteButtons.forEach(button => {
                button.addEventListener('click', function () {
                    currentNivelId = this.dataset.id;
            ...
            confirmDeleteButton.addEventListener('click', function () {
                if (currentNivelId) {
                    ...
                    deleteForm.action = `/admin/niveles/${currentNivelId}`;
                    deleteForm.submit();
                }
            });
