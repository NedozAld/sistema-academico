        ...
        <div class="max-w-4xl mx-auto">
            <div class="flex justify-end mb-6">
                <a href="{{ route('admin.dias.create') }}"
                   class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-full shadow-lg text-white bg-teal-600 hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 transition duration-300 ease-in-out transform hover:scale-105">
            ...
            <div class="bg-white overflow-hidden shadow-2xl sm:rounded-3xl p-8 lg:p-10 border border-gray-200">
                ...
                {{-- Contenido principal: Tabla de días o mensaje de vacío --}}
                @if($dias->count())
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-teal-600 text-white">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-semibold uppercase tracking-wider">Nombre del Día</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach($dias as $dia)
                                    <tr class="hover:bg-gray-50 transition duration-150 ease-in-out">
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{{ $dia->iddia }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{{ $dia->nombredia }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            ...
                                            <form action="" method="POST" class="inline-block">
                                                ...
                                                <button type="submit"
                                                        ...
                                                        onclick="return confirm('¿Estás seguro de que quieres eliminar este día?');">
                                                    Eliminar
                                                </button>
                                            </form>
                                        </td>
                ...
                @else
                    <div class="text-center py-16 px-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-700 mb-4">No hay días registrados aún.</p>
                        <p class="text-lg text-gray-500">Puedes añadir nuevos días usando el botón "Nuevo Día".</p>
                    </div>
                @endif
            </div>
        </div>
